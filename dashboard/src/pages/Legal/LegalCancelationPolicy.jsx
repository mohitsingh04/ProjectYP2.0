...
export default function LegalCancleationPolicy() {
  ...
  const getLegal = useCallback(async () => {
    try {
      ...
      setLegalPolicy(response.data.cancelationPolicy);
    } catch (error) {
      console.log(error);
    } finally {
      setLoading(false);
    ...
    <div>
      <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div>
          ...
          <Breadcrumb className="mb-0">
            ...
            <Breadcrumb.Item active>Cancelation Policy</Breadcrumb.Item>
          </Breadcrumb>
        </div>
      ...
      <Row>
        <Col>
          <Card>
            <Card.Header>
              <Card.Title>Cancelation Policy</Card.Title>
            </Card.Header>
            <Card.Body>
              {loading ? (
                <div>
                ...
                <Form onSubmit={formik.handleSubmit}>
                  <Form.Group controlId="disclaimer">
                    <Form.Label>Enter Cancelation Policy</Form.Label>
                    <JoditEditor
                      ref={editor}
                      value={formik.values.cancelationPolicy}
                      onBlur={(newContent) =>
                        formik.setFieldValue("cancelationPolicy", newContent)
                      }
                      onChange={(newContent) =>
                        formik.setFieldValue("cancelationPolicy", newContent)
                      }
