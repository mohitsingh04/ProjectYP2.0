                            ...
                            <Card className="custom-card">
                                ...
                                <Card.Body className="bd-example-row">
                                    <Container className="mb-3">
                                        <Row>
                                            <Col sm={6} className="col-6">.col-6 .col-sm-3</Col>
                                            <Col sm={6} className="col-6">.col-6 .col-sm-3</Col>
                    ...
                    <Card className="custom-card">
                        <Card.Body>
                            ...
                            <div className="clearfix">
                                <img src={ALLImages('media15')} className="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="..." />
                                <p>
