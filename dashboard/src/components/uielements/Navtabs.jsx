...
const Navtabs = () => {
    return (
        <Fragment>
            <Pageheader homepage="Navs & Tabs" activepage="UI Elements" page='Navs & Tabs' />
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <Tab.Container defaultActiveKey="second">
                                ...
                                <Tab.Content id="myTabContent">
                                    <Tab.Pane className="fade text-muted" id="order-tab-pane" role="tabpanel" eventKey="first" aria-labelledby="home-tab" tabIndex={0}>
                                    ...
                                    <Tab.Pane className="fade text-muted" id="confirm-tab-pane" eventKey="second" role="tabpanel" aria-labelledby="profile-tab" tabIndex={0}>
                                        <ul className="ps-3 mb-0">
                                            <li className="mb-2">
                                    ...
                                    <Tab.Pane className="fade text-muted" id="shipped-tab-pane" role="tabpanel" eventKey="third" aria-labelledby="contact-tab" tabIndex={0}>
                                        <ul className="ps-3 mb-0">
                                            <li className="mb-2">
                                    ...
                                    <Tab.Pane className="fade text-muted" id="delivered-tab-pane" role="tabpanel" tabIndex={0} eventKey="fourth">
                            ...
                            <Tab.Container defaultActiveKey="first">
                                <nav>
                                    <Nav variant="pills" className="nav-tabs nav-justified tab-style-4 d-flex" id="myTab2" role="tablist" defaultActiveKey="first">
                                        ...
                                        <Nav.Link eventKey="third" id="nav-contact-tab" type="button">About</Nav.Link>
                                    </Nav>
                                </nav>
            ...
            <Row className="row-sm">
                <Col xl={4}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <Tab.Container defaultActiveKey="first">
                                <Nav as="ul" variant="pills" className="nav-tabs mb-3 tab-style-6" id="myTab" role="tablist" defaultActiveKey="first">
                                ...
                                <Tab.Content id="myTabContent2">
                                    <Tab.Pane className="tab-pane fade show  p-0 border-bottom" id="products-tab-pane" eventKey="first"
                                        role="tabpanel" aria-labelledby="products-tab" tabIndex={0}>
                                        <div className="table-responsive">
                                            <table className="table mb-0">
                                                <thead>
                                                    <tr>
                                                        <th scope="col" className='rounded-tl-radius'>Product</th>
                                                        <th scope="col">Name</th>
                                                        <th scope="col">Category</th>
                                                        <th scope="col" className='rounded-tr-radius'>Price</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">
                                                            <span className="avatar avatar-sm">
                                                                <img src={ALLImages('png8')} alt="img" />
                                                            </span>
                                                        </th>
                                                        <td>Stop Watch</td>
                                                        <td>Clocks</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row">
                                                            <span className="avatar avatar-sm">
                                                                <img src={ALLImages('png5')} alt="img" />
                                                            </span>
                                                        </th>
                                                        <td>Chair</td>
                                                        <td>Furniture</td>
                                                    ...
                                                    <tr>
                                                        <th scope="row" className='rounded-bl-radius border-bottom-0'>
                                                            <span className="avatar avatar-sm">
                                                                <img src={ALLImages('png4')} alt="img" />
                                                            </span>
                                                        </th>
                                                        <td className='border-bottom-0'>Mini Pot</td>
                                                        <td className='border-bottom-0'>Plants</td>
                                                        <td className='rounded-br-radius border-bottom-0'>$799.00</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <Row>
                                    ...
                                    <Col md={8}>
                                        <Tab.Content id="v-pills-tabContent">
                                            <Tab.Pane className='p-2' id="main-profile" role="tabpanel" eventKey="first" tabIndex={0}>
            ...
            <Row className="row-sm">
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                                <Nav variant='pills' className="nav nav-tabs mb-3 border-bottom-0" role="tablist" defaultActiveKey="first">
                            ...
                            <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                                <Nav variant='pills' className="nav-pills mb-3" role="tablist" defaultActiveKey="first">
                                    ...
                                    <Dropdown className='nav-link'>
                                        <Dropdown.Toggle as='a' variant='' aria-expanded="false">Cart</Dropdown.Toggle>
                                        <Dropdown.Menu>
            ...
            <Row className="row-sm">
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                                <Nav variant='pills' className="flex-column flex-sm-row mb-3" role="tablist" defaultActiveKey="first">
